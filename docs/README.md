...
Please see my slide documentation in /ppt in CANVAS submission for detailed run down on plan, screenshots and features etx. Some screenshots included here as unsure exactly where they must be documented.
Please see the README submitted for assessment via CANVAS for screen images.
Only documents pertinent for public repo have been retained here.
